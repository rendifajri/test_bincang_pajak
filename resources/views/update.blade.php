    ...
    <body>
        <div class="container-fluid row">
            <div class="col-12">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="inv_no" placeholder="Ex : 001" value="{{$invoice->inv_no}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Issue Date</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="issue_date" placeholder="Ex : 2022-01-11" value="{{$invoice->issue_date}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Due Date</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="due_date" placeholder="Ex : 2022-02-11" value="{{$invoice->due_date}}">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="subject" placeholder="Ex : Spring Marketing Campaign" value="{{$invoice->subject}}">
                    </div>
                </div>
                <table class="table table-bordered">
                    ...
                    <tbody id="invoice_item">
                        ...
                        <tr>
                            <td>{{$row->item->item_type}}<input type="hidden" class="item_id" value="{{$row->item_id}}"></td>
                            <td>{{$row->item->name}}</td>
                            <td class="text-end">{{$row->qty}}<input type="hidden" class="qty" value="{{$row->qty}}"></td>
                            <td class="text-end">{{$row->price}}<input type="hidden" class="price" value="{{$row->price}}"></td>
                            <td class="text-end">{{$row->amount}}<input type="hidden" class="amount" value="{{$row->amount}}"></td>
                ...
                <div class="row mb-3">
                    <div class="col-12 text-end">
                        ...
                        <button type="button" onclick="create()" class="btn btn-warning">Update</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            function create(){
                ...
                console.log(data);
                $.post("{{ url('/') }}/api/invoice/update/{{$invoice->id}}", data)
                    .done(function(data){
                        // console.log(data);
